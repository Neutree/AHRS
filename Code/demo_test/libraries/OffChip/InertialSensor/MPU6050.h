...
protected:
  ...
  u8 _raw_data[15];      //raw data of MPU6050
	...
	bool _is_calibrate_gyro;       //flag of gyro calibration
	bool _is_calibrate_acc;        //flag of acc calibration
	Vector3f _gyro_calibrate_sum;  //sum of gyro for average aclibrate
